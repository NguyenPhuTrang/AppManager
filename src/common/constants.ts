...
export const FORM_VALIDATION = {
    ...
    name: /^(?=.*[a-zA-ZàáạảãâầấậẩẫăằắặẳẵèéẹẻẽêềếệểễđĐìíịỉĩòóọỏõôồốộổỗơờớợởỡùúụủũưừứựửữỳỹỷýÀÁẠẢÃÂẦẤẬẨẪĂẰẮẶẲẴÈÉẸẺẼÊỀẾỆỂỄĐỲỴỶỸÙÚỤỦŨƯỪỨỰỬỮÌÍỊỈĨÒÓỌỎÕÔỒỐỘỔỖƠỜỚỢỞỠỎỐỆỄỂỆỄỲÝỴỶỸ])(?!.*[0-9]{6,})[a-zA-Z0-9\sàáạảãâầấậẩẫăằắặẳẵèéẹẻẽêềếệểễđĐìíịỉĩòóọỏõôồốộổỗơờớợởỡùúụủũưừứựửữỳỹỷýÀÁẠẢÃÂẦẤẬẨẪĂẰẮẶẲẴÈÉẸẺẼÊỀẾỆỂỄĐỲỴỶỸÙÚỤỦŨƯỪỨỰỬỮÌÍỊỈĨÒÓỌỎÕÔỒỐỘỔỖƠỜỚỢỞỠỎỐỆỄỂỆỄỲÝỴỶỸ.,_-]+$/,
