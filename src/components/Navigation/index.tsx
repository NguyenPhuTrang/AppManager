    ...
    return (
        <div className="w-full py-4 px-6 flex items-center justify-between">
            ...
            <div className="flex items-center gap-[2px]">
                <div
                    onClick={selectCountPage !== 1 ? handlePrevPage : undefined}
                    className={`flex items-center justify-center select-none py-[6px] px-2 rounded-[4px] bg-[#F1F2F6]
                    ${selectCountPage === 1 ? 'cursor-not-allowed opacity-90' : 'cursor-pointer'}`}
                >
                ...
                <div
                    onClick={selectCountPage !== page.totalPages ? handleNextPage : undefined}
                    className={`flex items-center justify-center select-none py-[6px] px-2 rounded-[4px] bg-[#F1F2F6]
                    ${selectCountPage === page.totalPages ? 'cursor-not-allowed opacity-90' : 'cursor-pointer'}`}
                >
